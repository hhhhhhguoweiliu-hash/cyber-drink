...
Page({
  ...
  selectStyle(e) {
    this.applyStyle(e.currentTarget.dataset.style)
  },
  ...
  toggleMusic() {
    this.setData({ musicOn: audio.toggleMusic() })
  },
  ...
  goFaceDrink() {
    audio.playSfx('click')
    wx.navigateTo({ url: '/pages/face-drink/face-drink' })
  },
